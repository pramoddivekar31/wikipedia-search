/*! For license information please see main.e8521892.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, t, n) => {
        ...
        function Kr(e, t, n, r, a) {
          for (var o = t._reactName, l = []; null !== n && n !== r; ) {
            ...
            5 === i.tag &&
              ...
              ((i = s),
              a
                ? null != (u = ze(n, o)) && l.unshift($r(n, u, i))
                : a || (null != (u = ze(n, o)) && l.push($r(n, u, i)))),
              (n = n.return);
          }
        ...
        function qo(e, t, n, r) {
          ...
          "object" === typeof o && null !== o
            ? (a.context = Co(o))
            : ((o = za(t) ? Oa : Ta.current), (a.context = Ra(e, o))),
        ...
        function Ni(e, t, n, r, a, o) {
          Ci(e, t);
          var l = 0 !== (128 & t.flags);
          if (!r && !l) return a && ja(t, n, !1), $i(e, t, o);
        ...
        function cs(e, t) {
          ...
          try {
            ...
            0 === (Nu = n) && ((Hu = Ye() + 500), Aa && Wa());
          }
        }
        function fs(e) {
          null !== Xu && 0 === Xu.tag && 0 === (6 & Nu) && Es();
          var t = Nu;
          Nu |= 1;
          var n = Tu.transition,
            r = bt;
        ...
        function vs(e, t) {
          ...
          if ((ko(), (Nu = n), (Cu.current = r), null !== Ru))
            throw Error(o(261));
        ...
        function Cs(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Ou === e &&
              (zu & n) === n &&
              (4 === Iu ||
              (3 === Iu && (130023424 & zu) === zu && 500 > Ye() - Wu)
                ? ps(e, 0)
                : (Au |= n)),
            as(e, t);
        }
        ...
        function Hs(e, t, n, r, a, o, l, i, u) {
          return (
            ((e = Bs(n, r, !0, e, 0, o, 0, i, u)).context = Ws(null)),
            (n = e.current),
    ...
    (() => {
      ...
      class o extends t.Component {
        ...
        componentDidCatch(e, t) {
          console.log("Error caught by boundary:", e, t);
        }
        render() {
          return this.state.hasError
            ? (0, a.jsx)("div", {
                className: "error-boundry-container",
                children: (0, a.jsxs)("div", {
                  className: "error-boundry-content",
                  children: [
      ...
      const l = o;
      let i = (function (e) {
        return (e[(e.LIMIT = 50)] = "LIMIT"), (e[(e.OFFSET = 0)] = "OFFSET"), e;
      })({});
      const u = (e, n) => {
          const [r, a] = (0, t.useState)(e);
          return (
            (0, t.useEffect)(() => {
              const t = setTimeout(() => {
                a(e);
      ...
      function m(e, t) {
        ...
        for (var n = 0; n < e.length; n++)
          if (((r = e[n]), (a = t[n]), !(r === a || (h(r) && h(a))))) return !1;
        var r, a;
        return !0;
      }
      const g = function (e, t) {
        ...
        return function () {
          ...
          return (
            (o && n === this && t(l, a)) ||
              ((r = e.apply(this, l)), (o = !0), (n = this), (a = l)),
            r
          );
        };
      };
      ...
      function b(e, t) {
        ...
        var r = {
          id: requestAnimationFrame(function a() {
            v() - n >= t ? e.call(null) : (r.id = requestAnimationFrame(a));
          }),
        };
        return r;
      }
      ...
      function E(e) {
        if ((void 0 === e && (e = !1), null === k || e)) {
          ...
          return (
            ...
            document.body.appendChild(t),
            t.scrollLeft > 0
              ? (k = "positive-descending")
              : ((t.scrollLeft = 1),
                (k = 0 === t.scrollLeft ? "negative" : "positive-ascending")),
            document.body.removeChild(t),
            k
          );
        }
        ...
        return (
          (n = (function (e) {
            function n(t) {
              var n;
              return (
                ((n = e.call(this, t) || this)._instanceProps = s(
                  n.props,
                  f(n),
                )),
                (n._outerRef = void 0),
                ...
                (n._callOnItemsRendered = g(function (e, t, r, a) {
                ...
                (n._callOnScroll = g(function (e, t, r) {
                ...
                (n._getItemStyle = function (e) {
                  var t,
                    ...
                    i = a.itemSize,
                    u = a.layout,
                    s = n._getItemStyleCache(d && i, d && u, d && l);
                  if (s.hasOwnProperty(e)) t = s[e];
                  else {
                    var c = r(n.props, e, n._instanceProps),
                      f = o(n.props, e, n._instanceProps),
                      p = "horizontal" === l || "horizontal" === u,
                      h = "rtl" === l,
                      m = p ? c : 0;
                    s[e] = t = {
                      position: "absolute",
                ...
                (n._getItemStyleCache = g(function (e, t, n) {
                  return {};
                })),
                  ...
                  n.setState(function (e) {
                    ...
                    return (
                      (l = Math.max(0, Math.min(l, o - r))),
                      {
                        isScrolling: !0,
                        scrollDirection:
                          e.scrollOffset < l ? "forward" : "backward",
                        scrollOffset: l,
                        scrollUpdateWasRequested: !1,
                      }
                    );
                ...
                (n._onScrollVertical = function (e) {
                  ...
                  n.setState(function (e) {
                    ...
                    var t = Math.max(0, Math.min(o, a - r));
                    return {
                      isScrolling: !0,
                      scrollDirection:
                ...
                (n._resetIsScrollingDebounced = function () {
                  null !== n._resetIsScrollingTimeoutId &&
                    y(n._resetIsScrollingTimeoutId),
                    (n._resetIsScrollingTimeoutId = b(
                      n._resetIsScrolling,
                      150,
                    ));
                }),
            ...
            p(n, e),
              (n.getDerivedStateFromProps = function (e, t) {
                return C(e, t), h(e), null;
              });
            var m = n.prototype;
            return (
              (m.scrollTo = function (e) {
                (e = Math.max(0, e)),
              ...
              (m.scrollToItem = function (e, t) {
                ...
                this.scrollTo(l(this.props, e, t, o, this._instanceProps, i));
              }),
              ...
              (m.componentWillUnmount = function () {
                null !== this._resetIsScrollingTimeoutId &&
                  y(this._resetIsScrollingTimeoutId);
              }),
              (m.render = function () {
                var e = this.props,
                  n = e.children,
                  ...
                  for (var N = C; N <= P; N++)
                    T.push(
                      (0, t.createElement)(n, {
                        ...
                        style: this._getItemStyle(N),
                      }),
                    );
                var O = a(this.props, this._instanceProps);
              ...
              (m._callPropsCallbacks = function () {
                if (
                  ...
                  var e = this._getRangeToRender(),
                    ...
                    r = e[2],
                    a = e[3];
                  this._callOnItemsRendered(t, n, r, a);
                }
                if ("function" === typeof this.props.onScroll) {
                  var o = this.state,
                    l = o.scrollDirection,
                    i = o.scrollOffset,
                    u = o.scrollUpdateWasRequested;
                  this._callOnScroll(l, i, u);
                }
              }),
              (m._getRangeToRender = function () {
                ...
                var s = i(this.props, l, this._instanceProps),
                  c = u(this.props, s, l, this._instanceProps),
                  f = a && "backward" !== o ? 1 : Math.max(1, n),
                  d = a && "forward" !== o ? 1 : Math.max(1, n);
                return [
                  Math.max(0, s - f),
                  Math.max(0, Math.min(t - 1, c + d)),
                  s,
                  c,
                ];
              }),
      ...
      var C = function (e, t) {
        ...
        P = _({
          ...
          getOffsetForIndexAndAlignment: function (e, t, n, r, a, o) {
            var l = e.direction,
              i = e.height,
              u = e.itemCount,
              s = e.itemSize,
              c = e.layout,
              f = e.width,
              d = "horizontal" === l || "horizontal" === c ? f : i,
              p = Math.max(0, u * s - d),
              h = Math.min(p, t * s),
              m = Math.max(0, t * s - d + s + o);
            switch (
              ("smart" === n &&
                (n = r >= m - d && r <= h + d ? "auto" : "center"),
              n)
            ) {
              case "start":
                return h;
              case "end":
                return m;
              case "center":
                var g = Math.round(m + (h - m) / 2);
                return g < Math.ceil(d / 2)
                  ? 0
                  : g > p + Math.floor(d / 2)
                    ? p
                    : g;
              default:
                return r >= m && r <= h ? r : r < m ? m : h;
            }
          },
          ...
          getStopIndexForStartIndex: function (e, t, n) {
            var r = e.direction,
              ...
              u = e.width,
              s = t * l,
              c = "horizontal" === r || "horizontal" === i ? u : a,
              f = Math.ceil((c + n - s) / l);
          ...
          return t.length > 0
            ? (0, a.jsx)("div", {
                ...
                children: (0, a.jsx)(P, {
                  ...
                  children: (e) => {
                    ...
                    const { pageid: o, title: l } = t[n];
                    return (0, a.jsx)(a.Fragment, {
                      children: (0, a.jsx)(
                        "div",
                        { style: { ...r, padding: "10px" }, children: l },
                        o,
                      ),
                    });
                  },
            ...
            : (0, a.jsx)("div", {
                ...
                children: (0, a.jsx)("div", {
                  ...
                  children:
                    "Oops! No results found. Please enter a keyword to discover relevant information",
                }),
              });
        },
        N = (e) => {
          let { searchHistory: t } = e;
              ...
              t.length > 0
                ? (0, a.jsx)("ul", {
                    ...
                    children: t.map((e, t) =>
                      (0, a.jsx)(
                        "li",
                        { className: "search-history-item", children: e },
                        "".concat(e, "-").concat(t),
                      ),
                    ),
                  })
                : (0, a.jsx)("p", { children: "No search history available." }),
            ],
          });
        };
      function O(e, t) {
      ...
      var F;
      const I = (e) => ((e = e.toLowerCase()), (t) => L(t) === e),
        D = (e) => (t) => typeof t === e,
        { isArray: j } = Array,
        M = D("undefined");
      const A = I("ArrayBuffer");
      const U = D("string"),
        B = D("function"),
        W = D("number"),
      ...
      const G =
        ...
        Z = (e) => !M(e) && e !== G;
      const ee =
        ((te = "undefined" !== typeof Uint8Array && z(Uint8Array)),
        (e) => te && e instanceof te);
      var te;
      const ne = I("HTMLFormElement"),
        re = ((e) => {
        ...
        ie = "0123456789",
        ue = { DIGIT: ie, ALPHA: le, ALPHA_DIGIT: le + le.toUpperCase() + ie };
      const se = I("AsyncFunction"),
        ce = {
          isArray: j,
          isArrayBuffer: A,
          isBuffer: function (e) {
          ...
          isAsyncFn: se,
          isThenable: (e) => e && (H(e) || B(e)) && B(e.then) && B(e.catch),
        };
      ...
      [
        ...
        Object.defineProperties(fe, pe),
        Object.defineProperty(de, "isAxiosError", { value: !0 }),
        (fe.from = (e, t, n, r, a, o) => {
          const l = Object.create(de);
          return (
            ce.toFlatObject(
              e,
              l,
        ...
        function s(e, n, a) {
          ...
          if (e && !a && "object" === typeof e)
            if (ce.endsWith(n, "{}"))
              ...
              (ce.isArray(e) &&
                (function (e) {
                  return ce.isArray(e) && !e.some(me);
                })(e)) ||
              ((ce.isFileList(e) || ce.endsWith(n, "[]")) &&
                (i = ce.toArray(e)))
            )
              return (
                (n = ge(n)),
                i.forEach(function (e, r) {
                  !ce.isUndefined(e) &&
                    null !== e &&
                    t.append(
                      !0 === l ? ve([n], r, o) : null === l ? n : n + "[]",
                      u(e),
                    );
                }),
                !1
              );
          return !!me(e) || (t.append(ve(a, n, o), u(e)), !1);
        }
        const c = [],
          f = Object.assign(ye, {
            defaultVisitor: s,
        ...
        return (
          (function e(n, r) {
            if (!ce.isUndefined(n)) {
              ...
              c.push(n),
                ce.forEach(n, function (n, o) {
                  !0 ===
                    (!(ce.isUndefined(n) || null === n) &&
                      a.call(t, n, ce.isString(o) ? o.trim() : o, r, f)) &&
                    e(n, r ? r.concat(o) : [o]);
                }),
                c.pop();
            }
      ...
      const Ce = class {
        ...
        Oe =
          ((Re = "undefined" !== typeof navigator && navigator.product),
          Ne && ["ReactNative", "NativeScript", "NS"].indexOf(Re) < 0);
      var Re;
      const ze =
      ...
      const Fe = function (e) {
        function t(e, n, r, a) {
          ...
          const l = Number.isFinite(+o),
            i = a >= e.length;
          if (((o = !o && ce.isArray(r) ? r.length : o), i))
            return ce.hasOwnProp(r, o) ? (r[o] = [r[o], n]) : (r[o] = n), !l;
          (r[o] && ce.isObject(r[o])) || (r[o] = []);
          return (
            t(e, n, r[o], a) &&
              ce.isArray(r[o]) &&
              (r[o] = (function (e) {
      ...
      const Ie = {
        ...
        transformRequest: [
          function (e, t) {
            const n = t.getContentType() || "",
              ...
              a = ce.isObject(e);
            a && ce.isHTMLForm(e) && (e = new FormData(e));
            if (ce.isFormData(e)) return r ? JSON.stringify(Fe(e)) : e;
            if (
              ce.isArrayBuffer(e) ||
              ce.isBuffer(e) ||
              ce.isStream(e) ||
        ...
        transformResponse: [
          function (e) {
            ...
            if (e && ce.isString(e) && ((n && !this.responseType) || r)) {
      ...
      class We {
        ...
        set(e, t, n) {
          ...
          const o = (e, t) => ce.forEach(e, (e, n) => a(e, n, t));
          return (
            ce.isPlainObject(e) || e instanceof this.constructor
              ? o(e, t)
              : ce.isString(e) &&
                  (e = e.trim()) &&
        ...
        get(e, t) {
          if ((e = Ae(e))) {
            ...
            if (n) {
              ...
              if (ce.isFunction(t)) return t.call(this, e, n);
              if (ce.isRegExp(t)) return t.exec(e);
        ...
        delete(e, t) {
          ...
          function a(e) {
            if ((e = Ae(e))) {
              const a = ce.findKey(n, e);
              !a || (t && !Be(0, n[a], a, t)) || (delete n[a], (r = !0));
            }
          }
          return ce.isArray(e) ? e.forEach(a) : a(e), r;
        }
        clear(e) {
        ...
        normalize(e) {
          ...
          return (
            ce.forEach(this, (r, a) => {
              const o = ce.findKey(n, a);
              if (o) return (t[o] = Ue(r)), void delete t[a];
              const l = e
                ? (function (e) {
                    return e
                      .trim()
        ...
        static accessor(e) {
          ...
          return ce.isArray(e) ? e.forEach(r) : r(e), this;
        }
      }
      We.accessor([
        "Content-Type",
        ...
        ce.reduceDescriptors(We.prototype, (e, t) => {
          let { value: n } = e,
      ...
      ce.inherits(qe, he, { __CANCEL__: !0 });
      const Qe = qe;
      const Ke = Le.hasStandardBrowserEnv
        ? {
            write(e, t, n, r, a, o) {
              const l = [e + "=" + encodeURIComponent(t)];
              ce.isNumber(n) && l.push("expires=" + new Date(n).toGMTString()),
                ce.isString(r) && l.push("path=" + r),
                ce.isString(a) && l.push("domain=" + a),
                !0 === o && l.push("secure"),
      ...
      const Je = Le.hasStandardBrowserEnv
        ? (function () {
            ...
            return new Promise(function (t, n) {
              ...
              if (
                (c.open(
                  ...
                  _e(f, e.params, e.paramsSerializer),
                  !0,
                ),
                (c.timeout = e.timeout),
                "onloadend" in c
              ...
              void 0 === r && a.setContentType(null),
                ...
                ce.isUndefined(e.withCredentials) ||
      ...
      const et = (e) => "- ".concat(e),
        tt = (e) => ce.isFunction(e) || null === e || !1 === e,
        nt = (e) => {
          e = ce.isArray(e) ? e : [e];
          const { length: t } = e;
          let n, r;
          ...
          for (let o = 0; o < t; o++) {
            ...
            if (
              ...
              throw new he("Unknown adapter '".concat(t, "'"));
            if (r) break;
            a[t || "#" + o] = r;
          }
          if (!r) {
      ...
      function at(e) {
        ...
        return nt(e.adapter || De.adapter)(e).then(
          function (t) {
            return (
              rt(e),
      ...
      const ot = (e) => (e instanceof He ? e.toJSON() : e);
      function lt(e, t) {
        t = t || {};
        const n = {};
        function r(e, t, n) {
          return ce.isPlainObject(e) && ce.isPlainObject(t)
            ? ce.merge.call({ caseless: n }, e, t)
            : ce.isPlainObject(t)
              ? ce.merge({}, t)
              : ce.isArray(t)
                ? t.slice()
        ...
        function o(e, t) {
          if (!ce.isUndefined(t)) return r(void 0, t);
        }
        function l(e, t) {
          return ce.isUndefined(t)
            ? ce.isUndefined(e)
        ...
        const u = {
          ...
          responseEncoding: l,
          validateStatus: i,
          headers: (e, t) => a(ot(e), ot(t), !0),
        };
        return (
          ce.forEach(Object.keys(Object.assign({}, e, t)), function (r) {
            const o = u[r] || a,
              l = o(e[r], t[r], r);
            (ce.isUndefined(l) && o !== i) || (n[r] = l);
          }),
          n
        );
      }
      ...
      class dt {
        ...
        _request(e, t) {
          ...
          let o = a && ce.merge(a.common, a[t.method]);
          a &&
            ce.forEach(
        ...
        getUri(e) {
          return _e(
            Xe((e = lt(this.defaults, e)).baseURL, e.url),
            e.params,
            e.paramsSerializer,
          );
        }
      ...
      class ht {
        constructor(e) {
          ...
          this.promise.then((e) => {
            ...
            e(function (e, r, a) {
              n.reason || ((n.reason = new Qe(e, r, a)), t(n.reason));
            });
        }
        throwIfRequested() {
      ...
      const yt = (function e(t) {
        ...
        return (
          ce.extend(r, pt.prototype, n, { allOwnKeys: !0 }),
          ce.extend(r, n, null, { allOwnKeys: !0 }),
          (r.create = function (n) {
            return e(lt(t, n));
          }),
          r
      ...
      (yt.Axios = pt),
        ...
        (yt.mergeConfig = lt),
        (yt.AxiosHeaders = He),
        (yt.formToJSON = (e) => Fe(ce.isHTMLForm(e) ? new FormData(e) : e)),
        (yt.getAdapter = nt),
        (yt.HttpStatusCode = vt),
        (yt.default = yt);
      const bt = yt,
        wt = (0, t.createContext)(void 0),
        St = (e) => {
          let { children: n } = e;
            ...
            children: [
              (0, a.jsxs)("section", {
                ...
                children: [
                  ...
                  (0, a.jsxs)("div", {
                    children: [
                      (0, a.jsx)("h1", { children: "Wikipedia" }),
                      (0, a.jsx)("h5", { children: "The Free Encyclopedia" }),
                    ],
                  }),
                ],
              }),
              (0, a.jsx)(N, { searchHistory: r }),
              (0, a.jsx)(s, {
                onSearchInputChange: async (e) => {
                  try {
                    if ((u(!0), !e)) return void n([]);
                    const t = "http://localhost:8080".concat("/api/search"),
                      r = await bt.get(t, {
                        params: { query: e, limit: i.LIMIT, offset: i.OFFSET },
                      });
                    n(null === r || void 0 === r ? void 0 : r.data),
                      o((t) => [...t, e]);
                  } catch (t) {
                    c("Failed to load the results. Please try again.");
                  } finally {
                    u(!1);
                  }
                },
              ...
              l
                ...
                : (0, a.jsx)(T, { searchResults: e }),
            ],
          });
        };
      const xt = function () {
          return (0, a.jsx)(l, {
            children: (0, a.jsx)(St, { children: (0, a.jsx)(Et, {}) }),
          });
        },
        _t = (e) => {
          e &&
      ...
      r
        ...
        .render((0, a.jsx)(t.StrictMode, { children: (0, a.jsx)(xt, {}) })),
        _t();
    })();
})();
//# sourceMappingURL=main.e8521892.js.map
